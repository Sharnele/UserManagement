...
{
    public partial class LoContext : DbContext
    {
        public LoContext()
        {
        }

        public LoContext(DbContextOptions<LoContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Depense>(entity =>
            {
                ...
                entity.HasOne(d => d.IdmoisNavigation)
                    ...
                    .HasConstraintName("FK__Depense__idmois__68487DD7");
            });
            ...
            modelBuilder.Entity<Mois>(entity =>
            {
                ...
                entity.Property(e => e.Annees)
                    .HasColumnName("annees")
                    .HasMaxLength(30)
                    .IsUnicode(false);

                entity.Property(e => e.Idperiode).HasColumnName("idperiode");

                entity.Property(e => e.Mois1)
                    .HasColumnName("mois")
                    .HasMaxLength(30)
                    .IsUnicode(false);
                ...
                entity.HasOne(d => d.IdperiodeNavigation)
                    ...
                    .HasConstraintName("Mois_Periode");
            });
            ...
            modelBuilder.Entity<Revenu>(entity =>
            {
                ...
                entity.HasOne(d => d.IdmoisNavigation)
                    .WithMany(p => p.Revenu)
                    .HasForeignKey(d => d.Idmois)
                    .HasConstraintName("FK__Revenu__idmois__656C112C");
            });
